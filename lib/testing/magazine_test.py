...
class TestMagazine:
    ...
    def test_category_is_mutable_string(self):
        ...
        magazine_2.category = "Technology"
        assert magazine_2.category == "Technology"
    ...
    def test_category_len(self):
        ...
        magazine_1.category = "Health"
        assert magazine_1.category == "Health"
